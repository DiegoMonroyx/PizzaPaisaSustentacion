...
<body>
    ...
    <footer class="container-fluid d-flex justify-content-center align-items-center" style="background-color: #239227;">
        <p class="pt-2" style="color: white; font-weight: bold;">@La mejor pizza de pais</p>
    </footer>
